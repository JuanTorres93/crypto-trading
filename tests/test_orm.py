...
def test_mapper_can_load_trade(testing_session, generic_trade_defaults):
    testing_session.execute(
        f"""
        INSERT INTO trade (symbol, vs_currency_symbol, timeframe, stop_loss, entry_price,
        take_profit, status, vs_currency_entry, crypto_quantity_entry, entry_fee_vs_currency,
        ...
        '{generic_trade_defaults.vs_currency_symbol}', '{generic_trade_defaults.timeframe}', 
        ...
        {generic_trade_defaults.vs_currency_entry}, {generic_trade_defaults.crypto_quantity_entry}, 
        {generic_trade_defaults.entry_fee_vs_currency}, '{generic_trade_defaults.position}', 
